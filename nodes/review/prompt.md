...
## Completed stages
- **specify**: success
  - Model: MiniMax-M2.7-highspeed, 1.0m tokens in / 10.4k out
  - Files: fabro/programs/myosu-product.yaml, fabro/run-configs/product/agent-integration.toml, fabro/workflows/bootstrap/agent-integration.fabro, outputs/agent-integration/agent-adapter.md, outputs/agent-integration/review.md
