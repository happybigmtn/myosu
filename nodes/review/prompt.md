...
## Completed stages
- **specify**: success
  - Model: MiniMax-M2.7-highspeed, 1.6m tokens in / 13.5k out
  - Files: fabro/run-configs/bootstrap/foundations.toml, fabro/workflows/bootstrap/foundations.fabro, outputs/foundations/foundation-plan.md, outputs/foundations/review.md
