...
true`
- **implement**: success
  - Model: gpt-5.4, 2.1m tokens in / 22.8k out
...
cargo test pipe::is_plain_text`
  ...
  - Stderr:
    ...
    ```
- **fixup**: success
  - Model: gpt-5.4, 426.3k tokens in / 11.0k out
  - Files: outputs/tui/shell/implementation.md, outputs/tui/shell/integration.md, outputs/tui/shell/spec.md, outputs/tui/shell/verification.md
- **verify**: fail
  - Script: `set -e
cargo test events:: --no-ignore
cargo test shell:: --integration
