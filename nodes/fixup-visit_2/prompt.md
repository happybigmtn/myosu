...
cargo test -p myosu-games-poker training::tests::session_checkpoint_frequency`
  - Stdout:
    ...
    ---- training::tests::session_no_checkpoint stdout ----
    
    thread 'training::tests::session_no_checkpoint' (2740277) panicked at /home/r/.cargo/git/checkouts/robopoker-092d043dee5e8d7f/0471631/crates/nlhe/src/encoder.rs:33:14:
    isomorphism not found in abstraction lookup
  ...
  - Stderr:
    ...
    warning: `myosu-games-poker` (lib) generated 1 warning (run `cargo fix --lib -p myosu-games-poker` to apply 1 suggestion)
    ...
    ```
- **fixup**: success
  - Model: MiniMax-M2.7-highspeed, 0 tokens in / 55 out
  - Files: crates/myosu-games-poker/src/exploit.rs, crates/myosu-games-poker/src/solver.rs, crates/myosu-games-poker/src/wire.rs, outputs/games/poker-engine/implementation.md, outputs/games/poker-engine/verification.md
- **verify**: fail
  - Script: `set -e
cargo build -p myosu-games-poker
cargo test -p myosu-games-poker
...
- failure_signature: verify|deterministic|script failed with exit code: <n> ## stdout running <n> tests test exploit::tests::remote_matches_local_returns_err ... failed test query::tests::handle_invalid_info_bytes ... ok test exploit::tests::random_strategy_high_exploit ... failed 
