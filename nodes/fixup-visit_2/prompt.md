...
true`
  ...
  - Stderr:
    ...
    ```
- **implement**: success
  - Model: gpt-5.4, 2.0m tokens in / 28.0k out
...
- failure_signature: verify|deterministic|script failed with exit code: <n> ## stderr /bin/bash: line <n>: exits: command not found /bin/bash: line <n>: on: command not found error: package id specification `myosu-node` did not match any packages error: unexpected argument '--relea
