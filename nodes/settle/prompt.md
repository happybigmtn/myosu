...
cargo test -p myosu-games-poker training::tests::session_checkpoint_frequency`
  - Stdout:
    ...
    running 1 test
    test exploit::tests::trained_strategy_low_exploit ... ignored, requires database-hydrated NlheEncoder
    
    test result: ok. 0 passed; 0 failed; 1 ignored; 0 measured; 14 filtered out; finished in 0.00s
    
    
    running 1 test
    test exploit::tests::random_strategy_high_exploit ... ignored, requires database-hydrated NlheEncoder
    
    test result: ok. 0 passed; 0 failed; 1 ignored; 0 measured; 14 filtered out; finished in 0.00s
    
    
    running 1 test
    test exploit::tests::remote_matches_local ... ignored, requires database-hydrated NlheEncoder
    
    test result: ok. 0 passed; 0 failed; 1 ignored; 0 measured; 14 filtered out; finished in 0.00s
    
    
    running 1 test
    test training::tests::session_checkpoint_frequency ... ignored, requires database-hydrated NlheEncoder
  ...
  - Stderr:
    ...
    ```
- **fixup**: success
  - Model: MiniMax-M2.7-highspeed, 145 tokens in / 46 out
- **verify**: success
  - Script: `set -e
cargo build -p myosu-games-poker
cargo test -p myosu-games-poker
...
# Poker Engine Implementation Lane — Promotion

Decide whether `poker-engine-implement` is truly merge-ready.
