...
cargo test -p myosu-games-poker training::tests::session_checkpoint_frequency`
  ...
  - Stderr:
    ...
    warning: type alias `Flagship` is never used
      --> crates/myosu-games-poker/src/solver.rs:65:10
       |
    65 | pub type Flagship = rbp_nlhe::Flagship;
       |          ^^^^^^^^
    ...
    warning: `myosu-games-poker` (lib test) generated 12 warnings (run `cargo fix --lib -p myosu-games-poker --tests` to apply 8 suggestions)
