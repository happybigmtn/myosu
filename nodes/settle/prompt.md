...
cargo test -p myosu-games-poker training::tests::session_checkpoint_frequency`
  ...
  - Stderr:
    ...
    warning: `myosu-games-poker` (lib test) generated 4 warnings (run `cargo fix --lib -p myosu-games-poker --tests` to apply 1 suggestion)
    ...
    ```
- **fixup**: success
  - Model: MiniMax-M2.7-highspeed, 145 tokens in / 64 out
  - Files: ops/evidence/games-poker-engine-verification.md
- **verify**: success
  - Script: `set -e
cargo build -p myosu-games-poker
cargo test -p myosu-games-poker
