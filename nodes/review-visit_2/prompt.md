...
cargo test -p myosu-games-poker training::tests::session_checkpoint_frequency`
  ...
  - Stderr:
    ```
    (23 lines omitted)
         Running unittests src/lib.rs (/home/r/coding/myosu/.worktrees/autodev-live/.raspberry/cargo-target/debug/deps/myosu_games_poker-7ccd00c1c7701c82)
        Blocking waiting for file lock on package cache
        Blocking waiting for file lock on package cache
