...
## Completed stages
- **specify**: success
  - Model: gpt-5.4, 1.6m tokens in / 16.4k out
  - Files: outputs/README.md, outputs/agent-integration/agent-adapter.md, outputs/agent-integration/review.md, plans/031926-iterative-execution-and-raspberry-hardening.md
- **review**: fail
