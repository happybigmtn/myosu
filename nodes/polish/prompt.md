...
## Completed stages
- **specify**: success
  - Model: MiniMax-M2.7-highspeed, 3.5m tokens in / 22.3k out
  - Files: fabro/checks/chain-pallet-reset.sh, fabro/checks/chain-runtime-reset.sh, outputs/foundations/foundation-plan.md, outputs/foundations/review.md
- **review**: fail
