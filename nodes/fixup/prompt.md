...
cargo test -p myosu-games-poker training::tests::session_checkpoint_frequency`
  - Stdout:
    ...
    ---- training::tests::session_resume_from_checkpoint stdout ----
    
    thread 'training::tests::session_resume_from_checkpoint' (1878415) panicked at /home/r/.cargo/git/checkouts/robopoker-092d043dee5e8d7f/0471631/crates/nlhe/src/encoder.rs:33:14:
    isomorphism not found in abstraction lookup
...
- failure_signature: verify|deterministic|script failed with exit code: <n> ## stdout running <n> tests test exploit::tests::random_strategy_high_exploit ... failed test exploit::tests::remote_matches_local ... failed test query::tests::handle_invalid_info_bytes ... ok test query::
