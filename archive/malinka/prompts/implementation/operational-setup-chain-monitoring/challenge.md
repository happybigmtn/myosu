# Set up basic chain monitoring Lane — Challenge

Perform a cheap adversarial review of the current slice for `operational-setup-chain-monitoring` before the expensive final review runs.
