# Write the demo script Lane — Challenge

Perform a cheap adversarial review of the current slice for `e2e-demo-demo-script` before the expensive final review runs.
