# Harden dependency edges with explicit ordering Lane — Challenge

Perform a cheap adversarial review of the current slice for `raspberry-program-decomposition-harden-dependency-edges` before the expensive final review runs.
