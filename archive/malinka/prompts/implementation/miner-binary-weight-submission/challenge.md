# Implement weight submission to chain Lane — Challenge

Perform a cheap adversarial review of the current slice for `miner-binary-weight-submission` before the expensive final review runs.
