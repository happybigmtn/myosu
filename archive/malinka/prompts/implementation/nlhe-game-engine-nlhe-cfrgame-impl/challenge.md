# Implement CfrGame for NLHE (heads-up) Lane — Challenge

Perform a cheap adversarial review of the current slice for `nlhe-game-engine-nlhe-cfrgame-impl` before the expensive final review runs.
