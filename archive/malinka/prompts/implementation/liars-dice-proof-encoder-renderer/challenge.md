# Implement Encoder and GameRenderer Lane — Challenge

Perform a cheap adversarial review of the current slice for `liars-dice-proof-encoder-renderer` before the expensive final review runs.
