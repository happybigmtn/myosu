# Complete implement/ workflow family Lane — Challenge

Perform a cheap adversarial review of the current slice for `fabro-workflow-library-implement-family` before the expensive final review runs.
