# Wire poker renderer into TUI shell Lane — Challenge

Perform a cheap adversarial review of the current slice for `tui-full-implementation-wire-poker-renderer` before the expensive final review runs.
