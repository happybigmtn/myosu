# Add smoke test to all generated implementation programs Lane — Challenge

Perform a cheap adversarial review of the current slice for `fabro-quality-hardening-smoke-test-binaries` before the expensive final review runs.
