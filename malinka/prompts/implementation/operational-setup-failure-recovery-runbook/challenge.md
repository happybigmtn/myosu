# Write failure recovery runbook Lane — Challenge

Perform a cheap adversarial review of the current slice for `operational-setup-failure-recovery-runbook` before the expensive final review runs.
