...
- `EM-001` commit `5d306de4fcc43afedf5989165342c8f33610eac8`; validation: `cargo test -p pallet-game-solver coinbase --quiet`; `cargo test -p pallet-game-solver stage_0_flow --quiet`
