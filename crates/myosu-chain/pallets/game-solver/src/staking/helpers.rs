...
impl<T: Config> Pallet<T> {
    fn alpha_to_tao_value(netuid: NetUid, alpha: AlphaCurrency) -> TaoCurrency {
        U96F32::saturating_from_num(alpha)
            .saturating_mul(T::SwapInterface::stage0_current_alpha_price(netuid))
    ...
    pub fn get_total_stake_for_hotkey(hotkey: &T::AccountId) -> TaoCurrency {
        Self::get_all_subnet_netuids()
            ...
            .map(|netuid| {
                ...
                Self::alpha_to_tao_value(netuid, alpha).to_u64()
            })
            .sum::<u64>()
            .into()
    }
        ...
        if !Self::coldkey_owns_hotkey(coldkey, hotkey) {
            ...
            let min_alpha_stake =
                U96F32::saturating_from_num(Self::get_nominator_min_required_stake())
                    .safe_div(T::SwapInterface::stage0_current_alpha_price(netuid))
                    .saturating_to_num::<u64>();
